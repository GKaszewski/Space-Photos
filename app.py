...
cool_phenomena = ['nebula','orion','blazars','milky way','jupiter', 'Aurora', 'Sun', 'NuSTAR', 'solar flares', 'Galaxy Evolution Explorer GALEX', 'coronal mass ejection', 'ISS', 'KSC', 'star']
